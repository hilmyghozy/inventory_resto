                        ...
                        <div class="col-12">
                            ...
                            <div class="card-header">
                                ...
                                <div class="card-header-form">
                                    <form action="{{ url('report/sales/store') }}" method="post">
                                        @csrf
                                        ...
                                        <button class="btn btn-danger">Export <i class="fas fa-file-excel"></i></button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @foreach ($item as $key=>$value)
                                                    @if ($value->id_store == $data->id_store)
                                                        {{$value->nama_store}}
                                                    @endif
                                                @endforeach
                                            </td>
