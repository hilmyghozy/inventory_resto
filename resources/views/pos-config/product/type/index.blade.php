                          ...
                          <div class="card">
                            <div class="card-header">
                              ...
                              <div class="card-header-form">
                                <form action="{{ url('pos/item-type') }}" action="get">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="row mt-2">
                                                  <div class="col-lg-6">
                                                    <a href="{{ url('pos/item-type/edit', $data->id_size) }}" class="text-white btn btn-block btn-warning" style="background-color: #ffc107;color: #212529">
                                                      <i class="fas fa-pencil-alt"></i>
                                                    </a>
                                                    {{-- <button class="btn btn-block btn-warning"> Edit</button> --}}
                                                  </div>
                                                  <div class="col-lg-6" >
                                                      <form action="{{ url('pos/item-type', $data->id_size) }}" method="post">
                                                      @csrf 
                                                      @method('delete')
