            ...
            <div class="col-lg">
                ...
                <div class="card bg-white">
                    <div class="container">
                        ...
                        @endif
                        <form action="{{ url('pos/store/add') }}" method="POST">
                            @csrf 
                            <div class="form-row mt-3">
                              <div class="col-md-6 mb-3">
                                <label for="validationDefault02">Kode Store</label>
                                <input type="text" class="form-control" id="validationDefault02" placeholder="Kode Store" name="kode_store" required>
                              </div>
                              <div class="col-md-6 mb-3">
                                <label for="validationDefault03">Nama Store</label>
                                <input type="text" class="form-control" id="validationDefault03" placeholder="Nama Store" name="nama_store" required>
                              </div>
                              <div class="col-md-6 mb-3">
                                <label for="validationDefault04">Jumlah Meja</label>
                                <input type="number" min="0" class="form-control" id="validationDefault04" placeholder="Jumlah Meja" name="jumlah_meja" required>
                              </div>
                              <div class="col-md-6 mb-3">
                                <label for="validationDefault04">Printer Kasir</label>
                                <input type="text" class="form-control" id="validationDefault04" placeholder="Printer kasir" name="print_kasir" required>
                              </div>
                            </div>
                          ...
                          <div class="card">
                            <div class="card-header">
                              ...
                              <div class="card-header-form">
                                <form action="{{ url('pos/store') }}" action="get">
                                ...
                                <table class="table table-hover text-center" id="pos-store">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$data->print_kasir}}</td>
                                            <td>
                                                <div class="row">
                                                  <div class="col-lg-6">
                                                    <a href="{{ url('pos/store/edit', $data->id_store) }}" class="btn btn-block btn-warning" style="background-color: #ffc107;color: #212529"> Edit</a>
                                                    {{-- <button class="btn btn-block btn-warning"> Edit</button> --}}
                                                  </div>
                                                  <div class="col-lg-6" >
                                                      <form action="{{ url('pos/store/destroy', $data->id_store) }}" method="post">
                                                      @csrf 
                                                      @method('delete')
                                ...
                                <nav class="d-inline-block">
                                    <ul class="pagination mb-0">
                                      <li class="page-item mr-3 {{ $page_now==1 ? 'disabled' : '' }}">
                                        <a class="page-link" href="{{ url('pos/store?search='.$search.'&pagination='.($page_now-1)) }}" tabindex="-1"><i class="fas fa-chevron-left"></i></a>
                                      </li>
                                      @for ($i = 1; $i <= $count; $i++)
                                        <li class="page-item {{ $i==$page_now ? 'active' : '' }}">
                                          <a class="page-link" href="{{ url('pos/store?search='.$search.'&pagination='.$i) }}">{{ $i }}</a>
                                        </li>
                                      @endfor
                                      <li class="ml-3 page-item {{ $page_now==$count ? 'disabled' : '' }}">
                                        <a class="page-link" href="{{ url('pos/store?search='.$search.'&pagination='.($page_now+1)) }}"><i class="fas fa-chevron-right"></i></a>
                                      </li>
                                    </ul>
                                </nav>
                            </div>
