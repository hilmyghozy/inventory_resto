            ...
            <div class="col-lg">
                ...
                <div class="card bg-white">
                    <div class="container">
                        ...
                        <form action="{{ url('uc/user/updateProcess') }}" method="POST">
                            @csrf 
                            <div class="form-row mt-3">
                              ...
                              <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="validationDefault02" placeholder="Nama lengkap" name="nama" value="{{ $data->nama }}" required>
                              </div>

                              <div class="col-md-6 mb-3">
                                <label for="validationDefault03">Password</label>
                                <input type="password" class="form-control" id="validationDefault03" placeholder="Password" name="password" value="{{ $data->password }}" required>
                              </div>

                              <div class="col-md-6 mb-3">
                                <label for="validationDefault04">Role</label>
                                <select name="role" id="validationDefault04" class="form-control" required>
                                    <option value="cashier" {{ $data->role=="cashier"?"selected":null }}>Cashier</option>
                                    <option value="waiters" {{ $data->role=="waiters"?"selected":null }}>Waiters</option>
                                </select>
                              </div>
                            </div>
