...
<head>
    ...
    <title>Marinara's Login</title>
    <link rel="icon" href="{{ asset('home/images/logoM.png') }}">
...
{{--        <i class="fas fa-city"></i>--}}
        <img src="{{ asset('home/images/logoM.png') }}" class="img-fluid" ref="company logo" style="height: 100px">
    </div>
    <!-- /.login-logo -->
    <div class="card">
