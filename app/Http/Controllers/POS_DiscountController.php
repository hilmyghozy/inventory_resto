...
class POS_DiscountController extends Controller
{
    ...
    public function create(Request $request)
    {
        DB::table('pos_diskon')->insert([
            ...
            'tipe_voucher' => $request->tipe,
            'nominal' => ($request->nominal!=null?$request->nominal:null),
            'persen' => ($request->persen!=null?$request->persen:null),
            'maks_persen' => ($request->maks_persen!=null?$request->maks_persen:null),
            'is_used' => 0,
        ]);
